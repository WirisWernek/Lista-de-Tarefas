<?php
require $_SERVER['DOCUMENT_ROOT'] . '/models/Conexao.php';
require $_SERVER['DOCUMENT_ROOT'] . '/models/Tarefa.service.php';
require $_SERVER['DOCUMENT_ROOT'] . '/models/Tarefa.model.php';
